...
fun getMovies(): List<Movie>  {
    return listOf(
        Movie(id= "tt848319328",
            title = "Avatar",
            year = " 2009",
            genre = " Drama , Action , Adventure ",
            director = " James Cameron",
            actors = "Sam Worthington, Zoe Saldana, Sigourney Weaver, Steph.",
            plot =  "A paraplegic marine dispatched to the moon" ,
        ...
        Movie(id= "tt84831938",
            title = "Tere Naam",
            year = " 2007",
            genre = " Drama , HeartBroke",
            director = " YRF",
            actors = " Salman Khan",
            plot = " A psycho man deer killer",
        ...
        Movie(id= "tt8483193281",
            title = "The Wolf of Wall Street",
            year = " 2013",
            genre = " Biography, Comedy, Crime",
            director = " Martin Scorsese",
            actors =  "Leonardo DiCaprio, Jonah Hill, Margot Robbie, Matthew McConaughey",
            plot = "Based on the true story of Jordan Belfort, from his rise to a wealthy stock-broker living the high life to his fall involving",
        ...
        Movie(id= "tt84831933328",
            title = "The Avengers",
            year = " 2012",
            genre = " Action , Scientific , Thriller",
            director = " Marvel",
            actors = " Robert Downey Junior , Chris Hemsworth ",
            plot = "Earth's mightiest heroes must come together and learn to fight as a team if they are to stop the mischievous Loki and his alien",
